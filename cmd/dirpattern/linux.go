...
func (l *Linux) V_2021_2() map[string]string {
	return map[string]string{
		"./.config/JetBrains/GoLand2021.2":      "./.config/JetBrains/GoLand2021.2",
		"./.cache/JetBrains/GoLand2021.2":       "./.cache/JetBrains/GoLand2021.2",
		"./.java/.userPrefs/jetbrains/goland":   "./.java/.userPrefs/jetbrains/goland",
		"./.local/share/JetBrains/GoLand2021.2": "./.local/share/JetBrains/GoLand2021.2",
		"./.local/share/JetBrains/Goland":       "./.local/share/JetBrains/Goland",
	}
}
